...
timeSeries("Linear", 1)
pattern("Plain", 1, 1)
load(22, 20.0, 0.0, 0.0)
load(19, 15.0, 0.0, 0.0)
load(16, 12.5, 0.0, 0.0)
load(13, 10.0, 0.0, 0.0)
load(10, 7.5, 0.0, 0.0)
load(7, 5.0, 0.0, 0.0)
load(4, 2.5, 0.0, 0.0)
...
print("\n\nPeriod Comparisons:")
print(
    "{:>10}{:>15}{:>15}{:>15}".format("Period", "OpenSees", "SAP2000", "SeismoStruct")
)
...
for i in range(3):
    ...
    print(
        "{:>30}{:>15.3f}{:>15.2f}{:>15.2f}".format(
            comparisonResults[0][i],
            result,
